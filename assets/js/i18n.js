...
(function () {
  ...
  var DICT = {
    ...
    "Send via WhatsApp": "أرسِل عبر واتساب",
    "Your enquiry opens in WhatsApp so you can send it to us directly — we never share your details.": "يفتح طلبك في واتساب لإرساله إلينا مباشرة — ولا نشارك بياناتك أبداً.",
    "Opening WhatsApp so you can send your enquiry — just tap send.": "نفتح واتساب لإرسال طلبك — فقط اضغط إرسال.",
