...
(function () {
  ...
  var DICT = {
    ...
    /* ABOUT */
    "A technology partner grounded in discipline, taste, and judgment.": "شريك تقني راسخ في الانضباط والذوق وحُسن التقدير.",
    ...
    "TechSys exists to bring clarity to enterprise technology.": "وُجدت تك سيس لتجلب الوضوح إلى تقنية المؤسسات.",
    "Headquartered in Riyadh, TechSys is a premium IT solutions firm serving enterprises, institutions, and growing businesses across the Kingdom and beyond. We unite technical execution with business judgment across the full technology lifecycle — strategy, infrastructure, development, support, and procurement.": "يقع مقرّ تك سيس في الرياض، وهي شركة حلول تقنية معلومات متميّزة تخدم الشركات الكبرى والمؤسسات والأعمال النامية في المملكة وخارجها. نجمع بين التنفيذ التقني وحُسن التقدير في العمل عبر دورة حياة التقنية كاملة — استراتيجية وبنية تحتية وتطوير ودعم وتوريد.",
    ...
    "How TechSys performs in practice — the organisation, the brief, the services involved, and the outcome that mattered.": "كيف تؤدّي تك سيس عملها عملياً — المؤسسة، والموجز، والخدمات المعنيّة، والنتيجة التي صنعت الفرق.",
